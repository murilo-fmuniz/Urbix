...
def main():
    ...
    try:
        ...
        print("  1. Executar o servidor: uvicorn main:app --reload")
        print("  2. Acessar a documentação: http://localhost:8000/docs")
        print()
        print("Scripts úteis:")
        print("  - Atualizar dados do IBGE: python -m etl.ibge_etl")
        print("  - Migrar dados novamente: python -m scripts.migrate_data")
        print()
